...
public class NVBoids : MonoBehaviour
{
    ...
    private Transform thisTransform, dangerTransform;
    private int dangerBird;
    private Transform[] birdsTransform, flocksTransform;
    private Vector3[] rdTargetPos, flockPos, velFlocks;
    private float[] birdsSpeed, birdsSpeedCur, spVelocity;
    private int[] curentFlock;
    private float dangerSpeedCh, dangerSoaringCh;
